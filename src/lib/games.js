...
// Save a game we already have IGDB data for — used during bulk imports
// so we don't make a second IGDB request for each game.
export async function upsertGameFromData(igdbGame) {
